  ...
  return (
    <section className="py-8 px-4 sm:px-6 lg:px-16 bg-white dark:bg-black text-black dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="text-center mb-12">
        <p className="text-blue-600 dark:text-[#4ab8e9] font-semibold uppercase tracking-wide text-sm sm:text-lg">
          Built for Results
        </p>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-100 mb-4 leading-snug">
          Why Choose Us?
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
        {services.map((service, index) => (
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-base mt-4">{service.desc}</p>
          </div>
        ))}
      </div>
    </section>
