  ...
  return (
    <section className="py-12 bg-white dark:bg-black transition-colors duration-500 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          onClick={() => scroll("left")}
          className="absolute left-4 top-1/2 mt-20 -translate-y-1/2 hover:bg-red-600 p-3 rounded-full shadow-md bg-blue-600 hover:text-white transition z-20 group"
        >
        ...
        <button
          ...
          className="absolute right-4 top-1/2 mt-20 -translate-y-1/2 hover:bg-red-600 p-3 rounded-full shadow-md bg-blue-600 hover:text-white transition z-20 group"
        >
